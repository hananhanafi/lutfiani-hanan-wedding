...
export async function POST(req: NextRequest) {
  ...
  const {
    ...
    gift_qr_url, bank_name, bank_account_number, bank_account_name, bank_accounts_json,
  ...
  const updateData: Record<string, unknown> = {
    ...
    bank_accounts_json: bank_accounts_json ?? null,
    travel_info: travel_info || null,
    travel_info_en: travel_info_en || null,
    theme_color_primary,
